...
class Head(QGraphicsItem):
    ...
    def paint(self, painter, option, widget=None):
        ...
        if option.levelOfDetailFromTransform (QTransform()) > 0.5: # Outer eyes
            painter.setBrush(QBrush(Qt.yellow))
            painter.drawEllipse(-12, -19, 8, 8)
            painter.drawEllipse(-12, 11, 8, 8)
            if option.levelOfDetailFromTransform (QTransform()) > 0.9: # Inner eyes
            # if option.levelOfDetail > 0.9: # Inner eyes
                painter.setBrush(QBrush(Qt.darkBlue))
                painter.drawEllipse(-12, -19, 4, 4)
                painter.drawEllipse(-12, 11, 4, 4)
                if option.levelOfDetailFromTransform (QTransform()) > 1.3: # Nostrils
...
class Segment(QGraphicsItem):
    ...
    def paint(self, painter, option, widget=None):
        ...
        if option.levelOfDetailFromTransform(QTransform()) < 0.9:
