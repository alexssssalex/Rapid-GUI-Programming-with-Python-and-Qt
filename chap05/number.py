...
import chap05.numberformatdlg1
import chap05.numberformatdlg2
import chap05.numberformatdlg3
...
class Form(QDialog):
    ...
    def setNumberFormat1(self):
        dialog = chap05.numberformatdlg1.NumberFormatDlg(self.format, self)
        if dialog.exec_():
    ...
    def setNumberFormat2(self):
        dialog = chap05.numberformatdlg2.NumberFormatDlg(self.format, self)
        print('aaa')
    ...
    def setNumberFormat3(self):
        if self.numberFormatDlg is None:
            ...
            self.numberFormatDlg = chap05.numberformatdlg3.NumberFormatDlg(
