...
from chap06.helpform import *
from chap06.newimagedlg import *
from chap06.qrc_resources import *
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        settings = QSettings()
        # settings.setValue("RecentFiles", 'sasa')
    ...
    def loadInitialFile(self):
        ...
        fname = settings.value("LastFile", None, str)
    ...
    def fileSaveAs(self):
        ...
        formats =['*.' + format.data().decode() + ',' for format in QImageWriter.supportedImageFormats()]
        print('1')
